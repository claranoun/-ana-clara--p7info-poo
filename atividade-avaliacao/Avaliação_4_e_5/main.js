...
//Criar um Cliente 
let cliente = new cliente_1.Cliente(1, "Clara Nunes", 100, "600.563.845-55", tipo_cliente_1.TipoCliente.PESSOA_FISICA);
console.log("=========================");
console.log(cliente);
console.log("=========================");
...
let p1 = new produto_1.Produto(1, 150, "Feijão    magico", 8.50);
let p2 = new produto_1.Produto(2, 200, "CD do  Halmilton", 7.50);
let p3 = new produto_1.Produto(3, 300, "Cuscuz Juliettte", 4.00);
let p4 = new produto_1.Produto(4, 350, "Arroz      Mulan", 8.00);
let p5 = new produto_1.Produto(5, 400, "Banana  Heathers", 2.80);
